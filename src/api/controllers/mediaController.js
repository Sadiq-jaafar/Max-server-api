...
const mediaController = {
   // mediaController.js
    ...
    streamMedia: async (req, res) => {
      try {
        const { id } = req.params;
        console.log('-----------------------------------Streaming media with this id:]]]]]]]]]]]', id);
        ...
        // media_files\videos\5afd294c-b34c-43b8-8fdb-ffabce8a023f.mp4
        // Get file stats
...
console.log(thumbnailDir);
    ...
    updateMediaThumbnailForm : async (req, res) => {
      const {id} = req.params
        res.send(`
          <form action="/api/media/${id}/thumbnail" method="put" enctype="multipart/form-data">
